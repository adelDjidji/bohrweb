...
const colors ={
  "Tarif contrat H01":"red",
  "Tarif contrat H07":"blue",
  "Tarif contrat H16":"green",
  "Prix marché Spot":"black",
}
export function LineChart(
  data,
  {
    ...
    color =  (z)=>colors[z], //"currentColor", // stroke color of line, as a constant or a function of *z*
  ...
  // to remove duplicate
  d3.select("#chart123456 svg").remove();
