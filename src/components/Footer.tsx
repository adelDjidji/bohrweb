...
const Footer = () => {
  ...
  return (
    <footer className="flex w-full flex-col justify-between text-black-footer text-lg md:pt-20 pt-10 md:px-16 pl-5 pb-20 border-t-2 md:mt-0 mt-10">
      ...
      <div className="md:flex justify-around">
        ...
        <Link className="underline block" to="/cgv">
          CGV
        </Link>
        <Link className="underline block" to="/cgu">
          CGU
        </Link>
        <Link className="underline block" to="/legal-notice">
          Legal notice
        </Link>
      </div>
