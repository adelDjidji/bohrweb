    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div>
        ...
        <div className="flex mt-6 space-x-2">
          <button type="submit" style={{ backgroundColor: "#5819F1" }} className="inline-block px-4 py-3 text-xs font-medium leading-tight text-white rounded-lg shadow-md focus:shadow-lg focus:outline-none">
            Suivant
          </button>
        </div>
      </div>
