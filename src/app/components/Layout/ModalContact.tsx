        ...
        <div className="flex flex-col mt-12 gap-16">
          <div className="flex flex-col items-center">
            ...
            <Text type="16-500" className="text-center">
              Nos conseillers vous accompagnent au <b className="text-violet-bohr">06XXXXXXXX</b> .
            </Text>
          </div>
          <div className="flex flex-col items-center">
          <img className="mb-3" src="/images/Illustration mail.png" alt="Illustration mail" />
            ...
            <Text type="16-500" className="text-center">
            Envoyer un message à <b className="text-violet-bohr">luis.urday@bohr-energie.fr</b> .
            </Text>
          </div>
        </div>
      </Drawer>
