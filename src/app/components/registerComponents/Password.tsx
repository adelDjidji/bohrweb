...
function Password(props: any) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div>
        <label className="block mt-8 mb-2 text-base font-semibold text-gray-900 dark:text-white">Mot de passe</label>
        <div className="flex">
          <input
      ...
      <div>
        <label className="block mt-8 mb-2 text-base font-semibold text-gray-900 dark:text-white">Confirmer mot de passe</label>
        <div className="flex">
          <input
      ...
      <div className="flex mt-8 space-x-4">
        <button type="submit" className="bg-violet-bohr inline-block px-4 py-3 text-sm font-semibold leading-tight text-white transition duration-150 ease-in-out rounded-lg shadow-md focus:shadow-lg focus:outline-none focus:ring-0 active:bg-violet-bohr active:shadow-lg">
          Terminer
        </button>
      </div>
    </form>
