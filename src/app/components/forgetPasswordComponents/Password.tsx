...
function Password(props: any) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div>
        <label className="block mt-8 mb-2 text-base font-semibold text-gray-900 dark:text-white">Nouveau mot de passe</label>
        <div className="flex">
          <input
      ...
      <div>
        <label className="block mt-8 mb-2 text-base font-semibold text-gray-900 dark:text-white">Confirmer nouveau mot de passe</label>
        <div className="flex">
          <input
      ...
      <div className="flex mt-8 space-x-4">
        <button type="submit" className="inline-block bg-violet-bohr px-4 py-3 text-sm font-semibold leading-tight text-white transition duration-150 ease-in-out rounded-lg shadow-md focus:shadow-lg focus:outline-none focus:ring-0 active:bg-violet-bohr active:shadow-lg">
          Valider
        </button>
      </div>
    </form>
